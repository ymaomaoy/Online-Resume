...
education.display = function() {
  for (var i = 0; i < education.schools.length; i++) {
    ...
    $(".education-entry:last").append(formattedName, formattedCollege,
      formattedDates, formattedDegree);

    var newArray = education.schools[i].majors;
    newArray.forEach(function(major) {
  ...
  if (education.onlineCourses.length > 0) {
    ...
    for (var k = 0; k < education.onlineCourses.length; k++) {
      ...
      $(".onlinecourse-entry:last").append(TitleLink, formattedSchool, formattedDates);
    }
  }
};
...
skills.display = function() {
  ...
  $("#skills").append(formattedSkillMap, HTMLprofessionStart, HTMLcapabilityStart);
...
honor.display = function() {
  for (var i = 0; i < honor.certifications.length; i++) {
    ...
    $(".honor-entry:last").append(formattedName, formattedDates, formattedDescription);
  }
